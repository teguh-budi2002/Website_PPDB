    ...
    <div class="flex justify-center">
        <div class="w-3/5 bg-white shadow-md p-4 rounded mt-20">
          @if ($errors->any())
              ...
              @endforeach
          @endif
            <form action="{{ Route('form.step.four.process') }}" method="POST" enctype="multipart/form-data">
              @csrf
              <div class="smt_choice">
                ...
                <select class="w-full select select-sm" name="class_semester_id" id="class_smt">
                  <option value="smt_1">Semester 4</option>
                </select>
              </div>
              ...
              <div class="student_proof_of_grade_report mt-5">
                <label for="student_proof_of_grade_report" class="block text-sm mb-2">Bukti Nilai SMT 4</label>
