            ...
            <div class="flex flex-row -mx-3">
                ...
                <div class="px-3 text-right basis-1/3">
                    <div
                        ...
                        <i class="fa fa-solid fa-users leading-none text-lg relative top-3.5 text-white"></i>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div
            ...
            <div class="flex-auto p-4">
                <div class="py-4 pr-1 mb-4 bg-gradient-to-tl from-gray-900 to-slate-800 rounded-xl">
                    <div>
                        <img src="{{ asset('img/dashboard/chart_db_main.webp') }}"
                            class="w-full md:h-[280px] h-[100px] bg-cover bg-center" width="100%" height="170"
                            alt="chart dummy img">
                    </div>
                </div>
