...
<section class="register_page w-full h-full min-h-screen flex justify-center items-center">
  <div class="w-3/5 h-fit relative p-4 bg-white rounded-md border-2 border-blue-primary shadow-xl">
    <div class="left_section w-full absolute -left-40">
    ...
    <div class="flex justify-end">
      <div class="w-3/4 body_form mt-4">
        <form action="{{ Route('register.process') }}" method="POST">
          ...
          <div class="btn_submit mt-3">
            <button class="py-2.5 px-6 bg-blue-primary shadow-md text-white font-semibold rounded-md">DAFTAR</button>
          </div>
        </form>
      </div>
    </div>
